...
# def factorial(external_parameter):
#     while external_parameter > 0:
#         print(external_parameter*external_parameter)+(external_parameter-1)
#         external_parameter -=1
# external_parameter1 = 5
#
# factorial(external_parameter1)
n=3
